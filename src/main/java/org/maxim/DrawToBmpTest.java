...
public class DrawToBmpTest {
  ...
  static void runTests() throws IOException {
    DrawToBmpMain.main(a("picture.bmp", "150", "100", "clear", "FFFFFF", "spiral", "FF0000",
        "rect", "10", "10", "50", "30", "00FF00"));

    DrawToBmpMain.main(a("picture1.bmp", "300", "300", "clear", "FFFFFF", "Otetromino",
        "50", "50", "Itetromino", "100", "50", "Stetromino", "150", "50",
        "Ztetromino", "50", "120", "Ltetromino", "100", "120",
        "Jtetromino", "150", "120", "Ttetromino", "200", "120"));

    DrawToBmpMain.main(a("picture2.bmp", "100", "100", "clear", "a0a0a0",
        "Otetromino", "-5", "-5", "Itetromino", "90", "90", "Ttetromino", "80", "80"));

    DrawToBmpMain.main(a("picture3.bmp", "500", "500", "clear", "000000", "Itetromino", "0", "0",
        "Itetromino", "0", "100", "Itetromino", "0", "200", "Itetromino", "0", "300", "Itetromino", "0", "400"));

    DrawToBmpMain.main(a("picture4.bmp", "400", "400", "clear", "FFFFFF" , "rect", "10", "10", "380", "380", "000000",
